...
@class SBBacklightController; @class SBHomeScreenViewController; @class UIWKTextLoupeInteraction; @class SBHomeScreenPreviewView; @class UITouchesEvent; @class UITouch; @class CSQuickActionsViewController; @class SBScreenWakeAnimationController; @class _UIPlatterView; @class SBIdleTimerGlobalStateMonitor; @class SBIconView; @class CSCoverSheetView; @class CSFixedFooterView; @class SBHorizontalScrollFailureRecognizer; @class CSCombinedListViewController; @class WKWebView; @class SBCoverSheetWindow; @class SBIconListView; @class WKContentView; @class SBIconScrollView; @class SBDockView; @class SBMainStatusBarStateProvider; @class SpringBoard; @class CSPageViewController; @class SBFloatingDockPlatterView; @class SBMainWorkspace; @class SBFolderIconImageView; @class CSScrollView; @class CSMainPageView; @class SBHomeScreenOverlayViewController; @class SBDashBoardLockScreenEnvironment; @class SBLockScreenManager; @class SBFLockScreenDateView; @class CSCoverSheetViewController; @class SBUIProudLockIconView; @class CSTeachableMomentsContainerView; @class CSMainPageContentViewController; @class XENDashBoardWebViewController; @class SBRootFolderController; @class SBHomeScreenView; @class SBFluidSwitcherGestureWorkspaceTransaction; @class _UIContextMenuActionsListView; @class SBRootFolderView; @class SBIconListPageControl; 
...
static __attribute__((constructor)) void _logosLocalCtor_b6ed1931(int __unused argc, char __unused **argv, char __unused **envp) {
