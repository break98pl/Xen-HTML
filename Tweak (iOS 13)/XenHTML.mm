#line 1 "/Users/beesmacprom1/Desktop/TweakDev/Xen-HTML/Tweak (iOS 13)/XenHTML.xm"
...
@class SBIdleTimerGlobalStateMonitor; @class WKContentView; @class XENDashBoardWebViewController; @class SBIconController; @class CSCoverSheetViewController; @class SBRootFolderController; @class SBHomeScreenOverlayViewController; @class SBHomeScreenPreviewView; @class CSFixedFooterView; @class UITouch; @class SBHomeScreenView; @class SBScreenWakeAnimationController; @class SBIconListPageControl; @class _UIContextMenuActionsListView; @class SBFLockScreenDateView; @class _UIPlatterView; @class UIWKTextLoupeInteraction; @class SBUIProudLockIconView; @class CSMainPageContentViewController; @class SBIconView; @class SBLockScreenManager; @class CSCoverSheetView; @class CSMainPageView; @class SBDashBoardLockScreenEnvironment; @class CSCombinedListViewController; @class SBBacklightController; @class CSTeachableMomentsContainerView; @class SBHorizontalScrollFailureRecognizer; @class CSQuickActionsViewController; @class SBDockView; @class SBCoverSheetWindow; @class SBFloatingDockPlatterView; @class SBMainWorkspace; @class SBFluidSwitcherGestureWorkspaceTransaction; @class SBMainStatusBarStateProvider; @class CSPageViewController; @class SpringBoard; @class CSScrollView; @class SBRootFolderView; @class SBIconListView; @class SBHomeScreenViewController; @class SBFolderIconImageView; @class WKWebView; @class SBIconScrollView; @class UITouchesEvent; 
...
static BOOL _logos_method$SpringBoard$SBMainWorkspace$_preflightTransitionRequest$forExecution$(_LOGOS_SELF_TYPE_NORMAL SBMainWorkspace* _LOGOS_SELF_CONST __unused self, SEL __unused _cmd, SBMainWorkspaceTransitionRequest* arg1, BOOL arg2) {
    
    if ([[objc_getClass("SBLockScreenManager") sharedInstance] isUILocked]) {
        return _logos_orig$SpringBoard$SBMainWorkspace$_preflightTransitionRequest$forExecution$(self, _cmd, arg1, arg2);
    }
...
static SBHomeScreenPreviewView* _logos_method$SpringBoard$SBHomeScreenPreviewView$initWithFrame$iconController$wallpaperController$options$wallpaperImage$(_LOGOS_SELF_TYPE_INIT SBHomeScreenPreviewView* __unused self, SEL __unused _cmd, CGRect arg1, id arg2, id arg3, unsigned long long arg4, id arg5) _LOGOS_RETURN_RETAINED {
    _xenhtml_isPreviewGeneration = YES;
    
    id orig = _logos_orig$SpringBoard$SBHomeScreenPreviewView$initWithFrame$iconController$wallpaperController$options$wallpaperImage$(self, _cmd, arg1, arg2, arg3, arg4, arg5);
...
static void _logos_method$_ungrouped$SBIconController$viewWillAppear$(_LOGOS_SELF_TYPE_NORMAL SBIconController* _LOGOS_SELF_CONST __unused self, SEL __unused _cmd, BOOL animated) {
    _logos_orig$_ungrouped$SBIconController$viewWillAppear$(self, _cmd, animated);
    if(sbhtmlViewController)
...
static __attribute__((constructor)) void _logosLocalCtor_40f8f282(int __unused argc, char __unused **argv, char __unused **envp) {
