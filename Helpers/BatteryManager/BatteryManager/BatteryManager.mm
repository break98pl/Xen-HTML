#line 1 "/Users/beesmacprom1/Desktop/TweakDev/Xen-HTML/Helpers/BatteryManager/BatteryManager/BatteryManager.xm"
...
__attribute__((used)) static UIImageView * _logos_property$SpringBoard$XENHWidgetController$snapshotWebView(XENHWidgetController * __unused self, SEL __unused _cmd) { return (UIImageView *)objc_getAssociatedObject(self, (void *)_logos_property$SpringBoard$XENHWidgetController$snapshotWebView); }; __attribute__((used)) static void _logos_property$SpringBoard$XENHWidgetController$setSnapshotWebView(XENHWidgetController * __unused self, SEL __unused _cmd, UIImageView * rawValue) { objc_setAssociatedObject(self, (void *)_logos_property$SpringBoard$XENHWidgetController$snapshotWebView, rawValue, OBJC_ASSOCIATION_RETAIN_NONATOMIC); }
__attribute__((used)) static BOOL _logos_property$SpringBoard$XENHWidgetController$pendingHighStrategyLoad(XENHWidgetController * __unused self, SEL __unused _cmd) { NSValue * value = objc_getAssociatedObject(self, (void *)_logos_property$SpringBoard$XENHWidgetController$pendingHighStrategyLoad); BOOL rawValue; [value getValue:&rawValue]; return rawValue; }; __attribute__((used)) static void _logos_property$SpringBoard$XENHWidgetController$setPendingHighStrategyLoad(XENHWidgetController * __unused self, SEL __unused _cmd, BOOL rawValue) { NSValue * value = [NSValue valueWithBytes:&rawValue objCType:@encode(BOOL)]; objc_setAssociatedObject(self, (void *)_logos_property$SpringBoard$XENHWidgetController$pendingHighStrategyLoad, value, OBJC_ASSOCIATION_RETAIN_NONATOMIC); }
...
__attribute__((used)) static BOOL _logos_property$SpringBoard$WKWebView$_xh_isPaused(WKWebView * __unused self, SEL __unused _cmd) { NSValue * value = objc_getAssociatedObject(self, (void *)_logos_property$SpringBoard$WKWebView$_xh_isPaused); BOOL rawValue; [value getValue:&rawValue]; return rawValue; }; __attribute__((used)) static void _logos_property$SpringBoard$WKWebView$set_xh_isPaused(WKWebView * __unused self, SEL __unused _cmd, BOOL rawValue) { NSValue * value = [NSValue valueWithBytes:&rawValue objCType:@encode(BOOL)]; objc_setAssociatedObject(self, (void *)_logos_property$SpringBoard$WKWebView$_xh_isPaused, value, OBJC_ASSOCIATION_RETAIN_NONATOMIC); }
__attribute__((used)) static BOOL _logos_property$SpringBoard$WKWebView$_xh_requiresProviderUpdate(WKWebView * __unused self, SEL __unused _cmd) { NSValue * value = objc_getAssociatedObject(self, (void *)_logos_property$SpringBoard$WKWebView$_xh_requiresProviderUpdate); BOOL rawValue; [value getValue:&rawValue]; return rawValue; }; __attribute__((used)) static void _logos_property$SpringBoard$WKWebView$set_xh_requiresProviderUpdate(WKWebView * __unused self, SEL __unused _cmd, BOOL rawValue) { NSValue * value = [NSValue valueWithBytes:&rawValue objCType:@encode(BOOL)]; objc_setAssociatedObject(self, (void *)_logos_property$SpringBoard$WKWebView$_xh_requiresProviderUpdate, value, OBJC_ASSOCIATION_RETAIN_NONATOMIC); }
__attribute__((used)) static int _logos_property$SpringBoard$WKWebView$_xh_currentPauseStrategy(WKWebView * __unused self, SEL __unused _cmd) { NSValue * value = objc_getAssociatedObject(self, (void *)_logos_property$SpringBoard$WKWebView$_xh_currentPauseStrategy); int rawValue; [value getValue:&rawValue]; return rawValue; }; __attribute__((used)) static void _logos_property$SpringBoard$WKWebView$set_xh_currentPauseStrategy(WKWebView * __unused self, SEL __unused _cmd, int rawValue) { NSValue * value = [NSValue valueWithBytes:&rawValue objCType:@encode(int)]; objc_setAssociatedObject(self, (void *)_logos_property$SpringBoard$WKWebView$_xh_currentPauseStrategy, value, OBJC_ASSOCIATION_RETAIN_NONATOMIC); }


__attribute__((used)) static NSMutableArray * _logos_property$SpringBoard$WKWebView$_xh_pendingJavaScriptCalls(WKWebView * __unused self, SEL __unused _cmd) { return (NSMutableArray *)objc_getAssociatedObject(self, (void *)_logos_property$SpringBoard$WKWebView$_xh_pendingJavaScriptCalls); }; __attribute__((used)) static void _logos_property$SpringBoard$WKWebView$set_xh_pendingJavaScriptCalls(WKWebView * __unused self, SEL __unused _cmd, NSMutableArray * rawValue) { objc_setAssociatedObject(self, (void *)_logos_property$SpringBoard$WKWebView$_xh_pendingJavaScriptCalls, rawValue, OBJC_ASSOCIATION_RETAIN_NONATOMIC); }
...
static __attribute__((constructor)) void _logosLocalCtor_307b44d3(int __unused argc, char __unused **argv, char __unused **envp) {
    ...
    if (sb) {
        ...
        {Class _logos_class$SpringBoard$XENHWidgetController = objc_getClass("XENHWidgetController"); { objc_property_attribute_t _attributes[16]; unsigned int attrc = 0; _attributes[attrc++] = (objc_property_attribute_t) { "T", "@\"UIImageView\"" }; _attributes[attrc++] = (objc_property_attribute_t) { "&", "" }; _attributes[attrc++] = (objc_property_attribute_t) { "N", "" }; class_addProperty(_logos_class$SpringBoard$XENHWidgetController, "snapshotWebView", _attributes, attrc); size_t _nBytes = 1024; char _typeEncoding[_nBytes]; snprintf(_typeEncoding, _nBytes, "%s@:", @encode(UIImageView *)); class_addMethod(_logos_class$SpringBoard$XENHWidgetController, @selector(snapshotWebView), (IMP)&_logos_property$SpringBoard$XENHWidgetController$snapshotWebView, _typeEncoding); snprintf(_typeEncoding, _nBytes, "v@:%s", @encode(UIImageView *)); class_addMethod(_logos_class$SpringBoard$XENHWidgetController, @selector(setSnapshotWebView:), (IMP)&_logos_property$SpringBoard$XENHWidgetController$setSnapshotWebView, _typeEncoding); } { objc_property_attribute_t _attributes[16]; unsigned int attrc = 0; _attributes[attrc++] = (objc_property_attribute_t) { "T", @encode(BOOL) }; _attributes[attrc++] = (objc_property_attribute_t) { "N", "" }; class_addProperty(_logos_class$SpringBoard$XENHWidgetController, "pendingHighStrategyLoad", _attributes, attrc); size_t _nBytes = 1024; char _typeEncoding[_nBytes]; snprintf(_typeEncoding, _nBytes, "%s@:", @encode(BOOL)); class_addMethod(_logos_class$SpringBoard$XENHWidgetController, @selector(pendingHighStrategyLoad), (IMP)&_logos_property$SpringBoard$XENHWidgetController$pendingHighStrategyLoad, _typeEncoding); snprintf(_typeEncoding, _nBytes, "v@:%s", @encode(BOOL)); class_addMethod(_logos_class$SpringBoard$XENHWidgetController, @selector(setPendingHighStrategyLoad:), (IMP)&_logos_property$SpringBoard$XENHWidgetController$setPendingHighStrategyLoad, _typeEncoding); } { MSHookMessageEx(_logos_class$SpringBoard$XENHWidgetController, @selector(setPaused:animated:), (IMP)&_logos_method$SpringBoard$XENHWidgetController$setPaused$animated$, (IMP*)&_logos_orig$SpringBoard$XENHWidgetController$setPaused$animated$);}{ char _typeEncoding[1024]; unsigned int i = 0; _typeEncoding[i] = 'v'; i += 1; _typeEncoding[i] = '@'; i += 1; _typeEncoding[i] = ':'; i += 1; memcpy(_typeEncoding + i, @encode(BOOL), strlen(@encode(BOOL))); i += strlen(@encode(BOOL)); _typeEncoding[i] = '\0'; class_addMethod(_logos_class$SpringBoard$XENHWidgetController, @selector(_setInternalPaused:), (IMP)&_logos_method$SpringBoard$XENHWidgetController$_setInternalPaused$, _typeEncoding); }{ MSHookMessageEx(_logos_class$SpringBoard$XENHWidgetController, @selector(setPausedAfterTerminationRecovery:), (IMP)&_logos_method$SpringBoard$XENHWidgetController$setPausedAfterTerminationRecovery$, (IMP*)&_logos_orig$SpringBoard$XENHWidgetController$setPausedAfterTerminationRecovery$);}{ MSHookMessageEx(_logos_class$SpringBoard$XENHWidgetController, @selector(webView:didFailProvisionalNavigation:withError:), (IMP)&_logos_method$SpringBoard$XENHWidgetController$webView$didFailProvisionalNavigation$withError$, (IMP*)&_logos_orig$SpringBoard$XENHWidgetController$webView$didFailProvisionalNavigation$withError$);}{ MSHookMessageEx(_logos_class$SpringBoard$XENHWidgetController, @selector(_unloadWebView), (IMP)&_logos_method$SpringBoard$XENHWidgetController$_unloadWebView, (IMP*)&_logos_orig$SpringBoard$XENHWidgetController$_unloadWebView);}{ MSHookMessageEx(_logos_class$SpringBoard$XENHWidgetController, @selector(webView:didFinishNavigation:), (IMP)&_logos_method$SpringBoard$XENHWidgetController$webView$didFinishNavigation$, (IMP*)&_logos_orig$SpringBoard$XENHWidgetController$webView$didFinishNavigation$);}{ MSHookMessageEx(_logos_class$SpringBoard$XENHWidgetController, @selector(viewDidLayoutSubviews), (IMP)&_logos_method$SpringBoard$XENHWidgetController$viewDidLayoutSubviews, (IMP*)&_logos_orig$SpringBoard$XENHWidgetController$viewDidLayoutSubviews);}{ char _typeEncoding[1024]; unsigned int i = 0; _typeEncoding[i] = 'v'; i += 1; _typeEncoding[i] = '@'; i += 1; _typeEncoding[i] = ':'; i += 1; memcpy(_typeEncoding + i, @encode(BOOL), strlen(@encode(BOOL))); i += strlen(@encode(BOOL)); _typeEncoding[i] = '\0'; class_addMethod(_logos_class$SpringBoard$XENHWidgetController, @selector(_setInternalHidden:), (IMP)&_logos_method$SpringBoard$XENHWidgetController$_setInternalHidden$, _typeEncoding); }Class _logos_class$SpringBoard$WKWebView = objc_getClass("WKWebView"); { objc_property_attribute_t _attributes[16]; unsigned int attrc = 0; _attributes[attrc++] = (objc_property_attribute_t) { "T", @encode(BOOL) }; _attributes[attrc++] = (objc_property_attribute_t) { "N", "" }; class_addProperty(_logos_class$SpringBoard$WKWebView, "_xh_isPaused", _attributes, attrc); size_t _nBytes = 1024; char _typeEncoding[_nBytes]; snprintf(_typeEncoding, _nBytes, "%s@:", @encode(BOOL)); class_addMethod(_logos_class$SpringBoard$WKWebView, @selector(_xh_isPaused), (IMP)&_logos_property$SpringBoard$WKWebView$_xh_isPaused, _typeEncoding); snprintf(_typeEncoding, _nBytes, "v@:%s", @encode(BOOL)); class_addMethod(_logos_class$SpringBoard$WKWebView, @selector(set_xh_isPaused:), (IMP)&_logos_property$SpringBoard$WKWebView$set_xh_isPaused, _typeEncoding); } { objc_property_attribute_t _attributes[16]; unsigned int attrc = 0; _attributes[attrc++] = (objc_property_attribute_t) { "T", @encode(BOOL) }; _attributes[attrc++] = (objc_property_attribute_t) { "N", "" }; class_addProperty(_logos_class$SpringBoard$WKWebView, "_xh_requiresProviderUpdate", _attributes, attrc); size_t _nBytes = 1024; char _typeEncoding[_nBytes]; snprintf(_typeEncoding, _nBytes, "%s@:", @encode(BOOL)); class_addMethod(_logos_class$SpringBoard$WKWebView, @selector(_xh_requiresProviderUpdate), (IMP)&_logos_property$SpringBoard$WKWebView$_xh_requiresProviderUpdate, _typeEncoding); snprintf(_typeEncoding, _nBytes, "v@:%s", @encode(BOOL)); class_addMethod(_logos_class$SpringBoard$WKWebView, @selector(set_xh_requiresProviderUpdate:), (IMP)&_logos_property$SpringBoard$WKWebView$set_xh_requiresProviderUpdate, _typeEncoding); } { objc_property_attribute_t _attributes[16]; unsigned int attrc = 0; _attributes[attrc++] = (objc_property_attribute_t) { "T", @encode(int) }; _attributes[attrc++] = (objc_property_attribute_t) { "N", "" }; class_addProperty(_logos_class$SpringBoard$WKWebView, "_xh_currentPauseStrategy", _attributes, attrc); size_t _nBytes = 1024; char _typeEncoding[_nBytes]; snprintf(_typeEncoding, _nBytes, "%s@:", @encode(int)); class_addMethod(_logos_class$SpringBoard$WKWebView, @selector(_xh_currentPauseStrategy), (IMP)&_logos_property$SpringBoard$WKWebView$_xh_currentPauseStrategy, _typeEncoding); snprintf(_typeEncoding, _nBytes, "v@:%s", @encode(int)); class_addMethod(_logos_class$SpringBoard$WKWebView, @selector(set_xh_currentPauseStrategy:), (IMP)&_logos_property$SpringBoard$WKWebView$set_xh_currentPauseStrategy, _typeEncoding); } { objc_property_attribute_t _attributes[16]; unsigned int attrc = 0; _attributes[attrc++] = (objc_property_attribute_t) { "T", "@\"NSMutableArray\"" }; _attributes[attrc++] = (objc_property_attribute_t) { "&", "" }; _attributes[attrc++] = (objc_property_attribute_t) { "N", "" }; class_addProperty(_logos_class$SpringBoard$WKWebView, "_xh_pendingJavaScriptCalls", _attributes, attrc); size_t _nBytes = 1024; char _typeEncoding[_nBytes]; snprintf(_typeEncoding, _nBytes, "%s@:", @encode(NSMutableArray *)); class_addMethod(_logos_class$SpringBoard$WKWebView, @selector(_xh_pendingJavaScriptCalls), (IMP)&_logos_property$SpringBoard$WKWebView$_xh_pendingJavaScriptCalls, _typeEncoding); snprintf(_typeEncoding, _nBytes, "v@:%s", @encode(NSMutableArray *)); class_addMethod(_logos_class$SpringBoard$WKWebView, @selector(set_xh_pendingJavaScriptCalls:), (IMP)&_logos_property$SpringBoard$WKWebView$set_xh_pendingJavaScriptCalls, _typeEncoding); } { MSHookMessageEx(_logos_class$SpringBoard$WKWebView, @selector(initWithFrame:configuration:), (IMP)&_logos_method$SpringBoard$WKWebView$initWithFrame$configuration$, (IMP*)&_logos_orig$SpringBoard$WKWebView$initWithFrame$configuration$);}{ MSHookMessageEx(_logos_class$SpringBoard$WKWebView, @selector(_isBackground), (IMP)&_logos_method$SpringBoard$WKWebView$_isBackground, (IMP*)&_logos_orig$SpringBoard$WKWebView$_isBackground);}{ MSHookMessageEx(_logos_class$SpringBoard$WKWebView, @selector(evaluateJavaScript:completionHandler:), (IMP)&_logos_method$SpringBoard$WKWebView$evaluateJavaScript$completionHandler$, (IMP*)&_logos_orig$SpringBoard$WKWebView$evaluateJavaScript$completionHandler$);}{ char _typeEncoding[1024]; unsigned int i = 0; _typeEncoding[i] = 'v'; i += 1; _typeEncoding[i] = '@'; i += 1; _typeEncoding[i] = ':'; i += 1; _typeEncoding[i] = '\0'; class_addMethod(_logos_class$SpringBoard$WKWebView, @selector(_xh_postResume), (IMP)&_logos_method$SpringBoard$WKWebView$_xh_postResume, _typeEncoding); }Class _logos_class$SpringBoard$UIApp = objc_getClass("UIApp"); { MSHookMessageEx(_logos_class$SpringBoard$UIApp, @selector(isSuspendedUnderLock), (IMP)&_logos_method$SpringBoard$UIApp$isSuspendedUnderLock, (IMP*)&_logos_orig$SpringBoard$UIApp$isSuspendedUnderLock);}}
    }
}
